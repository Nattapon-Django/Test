    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-12">
        <div class="d-flex justify-content-center">
          ...
          <a href="http://103.91.207.135:1880/ui/#!/<?php echo $_GET['dv_id']; ?>?socketid=bc7euIluVYpV2pgXAACv" target="_blank"><button type="button" class="btn btn-primary mr-2"><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</button></a>

          <button class="btn btn-success"><i class="fa fa-download"></i>
            <a href="http://103.91.207.135/csv/device<?php echo $_GET['dv_id']; ?>.csv" style="color:white;text-decoration:none;">Export csv</a>
          </button><br>
          ...
          <table id="example" class="table table-striped" style="width:100%;">
            <thead>
              <tr>
                ...
                <th scope="col">Normal Temp</th>
                <th scope="col">Freed Temp</th>
              </tr>
            </thead>
            <tbody>
              <?php
        ...
        <div class="box">
          ...
          <div class="row mt-4">
            ...
            <div class="col-6">
              ...
              <div style="font-size:11px;color:#727272;">Normal Temp</div>
            </div>
            ...
            <div class="col-6">
              ...
              <div style="display: inline-block;">&#176;C</div>
              <div style="font-size:11px;color:#727272;">Freed Temp</div>
            </div>
