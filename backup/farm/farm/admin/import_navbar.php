<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a href="index.php"><img src="../logo.gif" width="100" height="40" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="show_user.php"><i class="fa fa-address-book" aria-hidden="true"></i> User Setting</a>
                    </li>
                </ul>
